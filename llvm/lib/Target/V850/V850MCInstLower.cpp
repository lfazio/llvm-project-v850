//===-- V850MCInstLower.cpp - Convert V850 MachineInstr to an MCInst ------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains code to lower V850 MachineInstrs to their corresponding
// MCInst records.
//
//===----------------------------------------------------------------------===//
...
MCSymbol *
V850MCInstLower::GetGlobalAddressSymbol(const MachineOperand &MO) const {
  return Printer.getSymbol(MO.getGlobal());
}

MCSymbol *
V850MCInstLower::GetExternalSymbolSymbol(const MachineOperand &MO) const {
...
MCSymbol *
V850MCInstLower::GetBlockAddressSymbol(const MachineOperand &MO) const {
...
void V850MCInstLower::Lower(const MachineInstr *MI, MCInst &OutMI) const {
